...
const StyleSelector = ({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    "Bold & Graphic":
      "High-contrast colors, strong typography, and striking visuals.",
    Minimalist:
      "Clean,simple, lots of white space, and a focus on essential elements.",
    Photorealistic: "Photo bases, Neutral tones.",
    Illustrated: "Hand-drawn, artistic, and often whimsical visuals.",
