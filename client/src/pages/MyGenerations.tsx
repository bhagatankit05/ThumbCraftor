...
const MyGenerations = () => {
  ...
  return (
    <>
      <SoftBackdrop />
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-24">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-zinc-200">My Generations</h1>
          <p className="text-sm text-zinc-400 mt-1">
            View & manage your generated thumbnails here.
          </p>
        </div>
        {loading && (
            ...
            {thumbnails.map((thumb: IThumbnail) => {
              ...
              return (
                <div
                  ...
                  className="mb-8 group relative cursor-pointer rounded-2xl bg-white/6 border border-white/10 transition shadow-xl break-inside-avoid hover:shadow-2xl"
                >
                  <div
                  ...
                  >
                    ...
                    <Link
                      target="_blank"
                      to={`/preview?thumbnail_url=${thumb.image_url} & ${thumb.title}`}
                    >
